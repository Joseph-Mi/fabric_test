...
exportChannel1Params () {
  ...
  export CHANNEL_CREATOR='CharityClient'
  export CHANNEL_ORDERER_ORG='CharityOrd'
  ...
  export ORDERER_CA="$NODE_PATH/msp/tlscacerts/tlsca.CharityOrd-cert.pem"
  ...
  export CHANNEL_MEMBER1_ORG='CharityClient'
  
  export CHANNEL_MEMBER1_NODE='Node2'
  export CHANNEL_MEMBER1_ORG='Donor'
  
  export NUM_MEMBERS='2'
  export NUM_ANCHORS='0'
  export CHANNEL_SIZE='2'
  export CHANNEL_ORGS=(CharityClient Donor)
